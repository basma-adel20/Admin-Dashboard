...
export default function Dashboard() {
  ...
  // Get a sample of properties for the preview table
    ...
    <div className="max-w-7xl mx-auto px-4 pb-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-sm font-medium text-gray-500">Booked Properties</h3>
              <p className="text-2xl font-semibold text-gray-900">{bookedProperties}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{formattedTotalSales}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden mb-8">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          ...
          <Link 
            to="/properties" 
            className="flex items-center text-[#443120] hover:text-[#443120]/80 text-sm font-medium"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="p-3 rounded-full bg-[#443120]/10 mr-4">
            <HomeModernIcon className="h-6 w-6 text-[#443120]" />
          </div>
          <div>
            <h3 className="font-medium text-gray-900">Add New Property</h3>
            <p className="text-sm text-gray-500">List a new rental property</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            <h3 className="font-medium text-gray-900">View All Properties</h3>
            <p className="text-sm text-gray-500">See complete property list</p>
          </div>
        </Link>
      </div>
    </div>
