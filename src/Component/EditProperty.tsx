  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#443120]"></div>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto px-4 max-w-7xl">
      <div className="flex items-center mb-5">
        <PencilIcon className="h-8 w-8 text-[#443120] mr-2" />
          ...
          <Form className="bg-white shadow rounded-lg px-10 py-8">
            ...
            <div className="mt-3 flex justify-end space-x-3">
              <button
                ...
                className="px-4 py-2 border border-gray-200 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#443120]"
              >
                Cancel
              </button>
              <button
